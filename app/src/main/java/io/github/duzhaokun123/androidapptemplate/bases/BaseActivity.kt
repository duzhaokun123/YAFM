...
import io.github.duzhaokun123.yafm.databinding.ActivityBaseRoot2Binding

abstract class BaseActivity<BaseBinding : ViewDataBinding>(
    @LayoutRes val layoutId: Int, vararg val configs: Config, @StyleRes val themeId: Int = R.style.Theme_YAFM
) : AppCompatActivity() {
    enum class Config {
        NO_TOOL_BAR,
        LAYOUT_NO_TOOL_BAR,
